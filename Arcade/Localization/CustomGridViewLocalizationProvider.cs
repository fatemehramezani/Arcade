...
namespace UserInterface.Localization
{
    class CustomGridViewLocalizationProvider : RadGridLocalizationProvider
    {
              public override string GetLocalizedString(string id)
        {
            switch (id)
            {
                ...
                case RadGridStringId.GroupingPanelDefaultMessage: return "برای گروه بندی ستونها، ستونی را به اینجا بکشید";
                case RadGridStringId.GroupingPanelHeader: return ":گروه بندی بر حسب";
